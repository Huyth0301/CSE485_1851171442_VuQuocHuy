...
<body>
    ...
    <div class="content clearfix">
        ...
        <div class="main-content single">
            <h1 class="post-title">Điểm chuẩn khoa công nghệ thông tin </Main></h1>
      ...
      <p class="description">Chiều 5/10, Đại học Thủy lợi công bố điểm chuẩn 15-22,75, cao nhất là ba ngành Công nghệ thông tin, Kỹ thuật phần mềm và Hệ thống thông tin.</p>
      <p style="text-align: justify;"><img alt="" src="https://i1-vnexpress.vnecdn.net/2020/10/05/TLA-PNG-9990-1601887944.png?w=0&h=0&q=100&dpr=2&fit=crop&s=qD2fMgQf44AOA0VXeVUs4A" style="width: 800px; height: 300px;" title=""></p> 
    </div>
      ...
      <div class="source"><span id="dnn_ctr531_ViewCMSView_ctl00_lblSource"></span></div>
      </article>
            </div>
        </div>
    ...
    <div class="footer">
        <div class="footer-content">
            ...
            <h2>Bộ môn trung tâm</h2><br/>
                <ul>
                    <a href="#"><li>Công nghệ phần mềm</li></a>
                    <a href="#"><li>Hệ thống thông tin</li></a>
                    <a href="#"><li>Khoa học máy tính</li></a>
                    <a href="#"><li>Kỹ thuật máy tính và mạng</li></a>
                    <a href="#"><li>Toán học</li></a>
